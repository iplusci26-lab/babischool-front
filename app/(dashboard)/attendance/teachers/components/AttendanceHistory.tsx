...
interface TeacherAbsenceHistory {
  teacher_id: string;
  teacher_name: string;
...
export default function AttendanceHistory() {
  ...
  const [openTeacher, setOpenTeacher] =
  ...
  const loadHistory = useCallback(async () => {
    ...
    try {
      ...
      const response =
        await api.get<AttendanceHistoryResponse>(
          "/attendance/teacher-attendance/history/",
          {
            params,
          }
        );
  ...
  function getJustificationLabel(
    status: string
  ) {
    switch (status) {
      case "justified":
      ...
      <div className="flex items-center justify-between">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">
            {filteredHistory.length} enseignant
      ...
      {filteredHistory.length === 0 ? (
        ...
        <div className="rounded-xl border bg-white p-10 text-center">
          ...
          <p className="mt-1 text-sm text-gray-500">
            Aucun enseignant absent pour la
                  ...
                  {isOpen && (
                    ...
                    <div className="border-t bg-gray-50/70 px-5 py-4">
                      ...
                      <div className="space-y-3">
                        ...
                        {teacher.absences.map(
                          (absence) => {

                            const isPrimary =
                              absence.assignment_type ===
                              "PRIMARY";
